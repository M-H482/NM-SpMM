...
float *values, *d_values, *hA, *hB, *hC;
int m = 1024; // bigger sizes may require dynamic allocations
...
int main(int argc, char* argv[])
{
    ...
    B_size = k * n * sizeof(float);
    C_size = m * n * sizeof(float);
    ...
    printf("TFLOPS = %f, Time= %f ms\n", 2.0 * m * n * k / 1e12 / ((ms_total / n_iter) / 1e3), ms_total / n_iter);
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
