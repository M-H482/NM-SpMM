...
float test_performance(nmGEMMFuncPtr_low_sparsity low_sparsity_kernel, nmGEMMFuncPtr_high_sparsity high_sparsity_kernel, int Ns,
    int M, int N, int K,
...
int main(int argc, char** argv)
{
    ...
    printf("kernel type = %d, SPLIT_K = %d\n", type, SPLIT_K);
